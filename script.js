...
const playlists = [
    ...
    { name: "Monsoon", q: "Bollywood Rain Songs", img: "https://images.unsplash.com/photo-1534274988757-a28bf1f5a9ad?w=300" },
...
function manualSeek(e) {
    let rect = document.querySelector('.progress-container').getBoundingClientRect();
